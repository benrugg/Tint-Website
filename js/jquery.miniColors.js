		...
		miniColors: function(o, data) {
			...
			var create = function(input, o, data) {
				...
				input
					...
					.data('mouseup', o.mouseup ? o.mouseup : null)
			...
			var show = function(input) {
				...
				$(document)
					...
					.on('mouseup.miniColors touchend.miniColors', function(event) {
						...
						// fire the mouse up callback
						if (input.data('mouseup')) {
							input.data('mouseup').call(input.get(0), '#' + hsb2hex(hsb), $.extend(hsb2rgb(hsb), { a: parseFloat(input.attr('data-opacity')) }));
						}
					})
